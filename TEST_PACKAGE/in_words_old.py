...
number = float (input('Введите fucking число '))
num_i = int(number)
...
#     num_e = NUM[I]
#     print (num_e)
#     print (NNN[num_e//100] + NN[(num_e % 100) // 10] + Nf[num_e %10] + MRD[num_e %10])
...
if (round (number - num_i,2)*100) ==0: 
    ...
    num_f = str(int((round (number - num_i,2)*100)))
...
if number >= 10**12 or number < 0:
    print ('Число за пределами допустимого диапазона')
